...
for transaction in daily_transactions_split:
  ...
  for item in transaction:
    clean_transaction.append(item.strip())
...
for colour in colours:
  print("Thread Shed sold {colour_count} threads of {colour} thread today".format
(colour_count=colour_count(colour), colour=colour))
